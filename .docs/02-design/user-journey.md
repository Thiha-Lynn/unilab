...
| **5** | Downloads the result, sees the custody countdown start, and taps **Delete now** | Holds the result in memory only; counts down from 30:00; purges on tab close | S3 · Download |

---

## The one decision that matters

At **step 3**, after the estimate appears:

> **Does the estimate already meet the cap?**
> - **[meets cap]** → continue to step 4.
> - **[misses cap]** → the student changes the target or the quality and the estimate
>   re-renders. They loop inside step 3; they do not burn a run to find out.
...
2. **Five steps, this order.** D4 shows exactly these, with the step-3 decision as a diamond.
